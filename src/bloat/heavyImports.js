/**
 * Heavy imports to bloat bundle size to ~50MB
 * This file imports large libraries and generates large data
 */

// Full lodash (not tree-shakeable when imported this way)
import _ from "lodash";

// Moment with ALL locales (~1MB)
...
// Moment timezone with all zones
...
// Highlight.js with all languages
...
export { _, moment, momentTimezone, THREE, d3, hljs, Prism, PDFDocument, XLSX };
